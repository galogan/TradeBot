...
class PyRobot():
    ...
    def _init_(self, client_id: str, redirect_uri: str, credentials_path: str = None, trading_account: str = None) -> None:
    ...
    # Method to create a TD ameriatrade session
    def _create_session(self) -> TDClient:
        ...
        #Methods defining when the markets are open and closed
        #TODO LOOK AT POSSIBLY RENAMING THE METHODS
    @property
...
def grab_currect_quotes(self) -> dict:
    pass

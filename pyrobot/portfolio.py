...
class Portfolio():
    ...
    def add_positions(self, positions: List[dict]) -> dict:
        ...
        if isinstance(positions, list):
            ...
            raise TypeError("Positions must be a llist of dictionaries. ")
    ...
    def remove_position(self, symbol: str) -> Tuple[bool, str]:
        ...
        if symbol in self.positions:
            ...
            return (False, "{Symbol} did not exist iln the portfolio.".format(Symbol=symbol))
    ...
    def is_profitable(self, symbol: str, current_price: float) -> bool:
        ...
        # Grabbing purchase price of stock
